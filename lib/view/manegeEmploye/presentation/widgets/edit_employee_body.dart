...
class EditEmployeeViewBody extends StatelessWidget {
  EditEmployeeViewBody({Key? key, required this.userId}) : super(key: key);
  String? password;
  final int userId;
    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            BlocBuilder<ManegeEmployeeCubit, ManegeEmployeeState>(
            ...
            SizedBox(
              ...
              child: CustomButton(
                fontSize: 14.sp,
                text: 'حفظ البيانات',
                onPress: () => cubit.editEmployee(userId: userId),
                //  onPress: () {}
              ),
            ),
          ],
